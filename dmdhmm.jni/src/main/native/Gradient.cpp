...
#include <org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_Gradient.h>
...
extern "C"
{
  ...
  /*
   * Class:     org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_Gradient
   * Method:    gradient
   * Signature: (Lorg/projectsforge/hmmtk4j/dmdhmm/SequenceOfObservations;Lorg/projectsforge/hmmtk4j/dmdhmm/HMM;Lorg/projectsforge/hmmtk4j/dmdhmm/HMM;)D
   */
  JNIEXPORT jdouble JNICALL Java_org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_Gradient_gradient(
      JNIEnv * jenv, jclass, jobject obs, jobject hmm, jobject gradient)
  {
    ...
    Ref<dmdhmm::IHMM> gradient_val = dmdhmm::Proxy_IHMM_getJavaObject(Object(jenv, gradient));
    Ref<ISequenceOfObservations> obs_val = Proxy_ISequenceOfObservations_getJavaObject(Object(jenv,
        obs));

    val = org::projectsforge::hmmtk4j::dmdhmm::gradient(obs_val, hmm_val, gradient_val);
