...
#include <org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_FastForwardWithWeightedObservations.h>
...
extern "C"
{
  ...
  /*
   * Class:     org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_FastForwardWithWeightedObservations
   * Method:    fastForwardWithWeightedObservations
   * Signature: (Lorg/projectsforge/hmmtk4j/dmdhmm/HMM;[Lorg/projectsforge/hmmtk4j/dmdhmm/WeightedSequenceOfObservations;)D
   */
  JNIEXPORT jdouble JNICALL Java_org_projectsforge_hmmtk4j_dmdhmm_nativeimplementors_FastForwardWithWeightedObservations_fastForwardWithWeightedObservations(
      JNIEnv * jenv, jclass, jobject inputHMM, jobjectArray observations)
  {
    ...
    val = org::projectsforge::hmmtk4j::dmdhmm::fastForwardWithWeightedObservations(inputhmm_val,
        observations_val);
