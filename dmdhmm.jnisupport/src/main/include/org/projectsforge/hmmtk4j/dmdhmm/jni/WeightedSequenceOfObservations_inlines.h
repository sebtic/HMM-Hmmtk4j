...
#ifndef HMMTK4J_DMDHMM_JNI_WeightedSequenceOfObservations_inlines_H
#define HMMTK4J_DMDHMM_JNI_WeightedSequenceOfObservations_inlines_H
    ...
    namespace hmmtk4j
    {
      namespace dmdhmm
      {
        namespace jni
        {
          ...
          {
            sequence = Proxy_ISequenceOfObservations_getJavaFieldObject(_self,
                "sequence");
