 ...
 * 
 * $Id: SegmentalKMeans.java 11 2010-08-31 15:52:23Z sebtic $
 */
...
public class SegmentalKMeans {

  static {
    Loader.load("hmmtk4j-discretehmm-jni");
  }

  public native static double segmentalKMeans(HMM inputHMM,
      SequenceOfObservations sequenceOfObservations, int nbMaxIteration, HMM outputHMM);
