...
public final class WeightedSequenceOfObservations implements Cloneable, Serializable, DeepCloneable {
   ...
   *
   */
  private static final long serialVersionUID = 6605358270972480932L;
   ...
   *          the weight
   */
  public WeightedSequenceOfObservations(final SequenceOfObservations sequenceOfObservations, final double weight) {
   ...
   */
  public WeightedSequenceOfObservations(final WeightedSequenceOfObservations weightedSequenceOfObservations) {
