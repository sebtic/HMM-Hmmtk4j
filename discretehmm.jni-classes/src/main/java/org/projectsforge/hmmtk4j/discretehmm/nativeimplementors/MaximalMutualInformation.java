 ...
 * 
 * HMMTK4J is free software: you can redistribute it and/or modify it under
 ...
 * 
 * $Id: MaximalMutualInformation.java 11 2010-08-31 15:52:23Z sebtic $
 */
...
public class MaximalMutualInformation {
  ...
  public static native double maximalMutualInformation(
      WeightedSequenceOfObservations[] positiveObservations,
      WeightedSequenceOfObservations[] negativeObservations, HMM inputHMM,
      int nbMaxIteration, HMM outputHMM);
}
