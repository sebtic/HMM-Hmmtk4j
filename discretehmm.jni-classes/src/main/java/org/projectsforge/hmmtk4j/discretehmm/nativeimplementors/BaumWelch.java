 ...
 * 
 * $Id: BaumWelch.java 11 2010-08-31 15:52:23Z sebtic $
 */
...
public final class BaumWelch {
  ...
  public native static double baumWelch(final HMM inputHMM, final SequenceOfObservations sequenceOfObservations,
      final int nbMaxIteration, final boolean reevaluateA, final boolean reevaluateB,
      final boolean reevaluatePi, final HMM outputHMM) throws IllegalStateException;
