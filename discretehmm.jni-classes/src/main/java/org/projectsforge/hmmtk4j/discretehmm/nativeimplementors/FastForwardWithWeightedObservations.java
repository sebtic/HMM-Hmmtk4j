 ...
 * 
 * $Id: FastForwardWithWeightedObservations.java 11 2010-08-31 15:52:23Z sebtic $
 */
...
public final class FastForwardWithWeightedObservations {

  static {
    Loader.load("hmmtk4j-discretehmm-jni");
  }

  public native static double fastForwardWithWeightedObservations(HMM hmm,
      WeightedSequenceOfObservations[] observations);
}
