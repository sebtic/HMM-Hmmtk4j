 ...
 * 
 * $Id: LabelledTraining.java 11 2010-08-31 15:52:23Z sebtic $
 */
...
public final class LabelledTraining {

  static {
    Loader.load("hmmtk4j-discretehmm-jni");
  }

  public native static void labelledTraining(SequenceOfObservations sequenceOfObservations, SequenceOfObservations stateSequence,
      double smoothing, HMM outputHMM);
}
