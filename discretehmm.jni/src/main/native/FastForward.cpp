...
#include <org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_FastForward.h>
...
extern "C"
{
  ...
  /*
   * Class:     org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_FastForward
   * Method:    fastForward
   * Signature: (Lhmmtk4j/discretehmm/HMM;Lhmmtk4j/SequenceOfObservations;)D
   */
  JNIEXPORT jdouble JNICALL Java_org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_FastForward_fastForward(
      JNIEnv * jenv, jclass, jobject hmm, jobject obs)
  {
    ...
    val = org::projectsforge::hmmtk4j::discretehmm::fastForward(hmm_val,
        obs_val);
