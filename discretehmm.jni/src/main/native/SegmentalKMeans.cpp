...
#include <org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_SegmentalKMeans.h>
...
#endif
  /*
   * Class:     org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_SegmentalKMeans
   * Method:    segmentalKMeans
   * Signature: (Lhmmtk4j/discretehmm/HMM;Lhmmtk4j/SequenceOfObservations;ILhmmtk4j/discretehmm/HMM;)D
   */
  JNIEXPORT jdouble JNICALL Java_org_projectsforge_hmmtk4j_discretehmm_nativeimplementors_SegmentalKMeans_segmentalKMeans(
      JNIEnv * jenv, jclass, jobject inputHMM, jobject observation,
      jint nbMaxIteration, jobject outputHMM)
  {
    ...
    val = org::projectsforge::hmmtk4j::discretehmm::segmentalKMeans(
        inputhmm_val, obs_val, nbMaxIteration, outputhmm_val);
