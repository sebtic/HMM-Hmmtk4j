 ...
 * 
 * $Id: Forward.java 8 2010-06-01 16:56:49Z sebtic $
 */
...
public class Forward extends Algorithm implements Serializable {
  ...
  protected void implement() {
    ...
    alphaTildes.resize(sequenceOfObservations.getLength(), inputHMM.getStateCount());
    rescalingCoefs.resize(sequenceOfObservations.getLength(), false);
    logOfTheProbability = org.projectsforge.hmmtk4j.dmdhmm.nativeimplementors.Forward.forward(
