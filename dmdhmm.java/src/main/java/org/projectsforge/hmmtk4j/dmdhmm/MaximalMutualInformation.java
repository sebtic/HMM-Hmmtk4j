 ...
 * 
 * $Id: MaximalMutualInformation.java 8 2010-06-01 16:56:49Z sebtic $
 */
...
public class MaximalMutualInformation extends Algorithm implements Serializable {
  ...
  protected void implement() {
    ...
    logOfTheProbability = org.projectsforge.hmmtk4j.dmdhmm.nativeimplementors.MaximalMutualInformation
        .maximalMutualInformation(positivesObservations
            .toArray(new WeightedSequenceOfObservations[0]), negativesObservations
            .toArray(new WeightedSequenceOfObservations[0]), inputHMM, nbMaxIteration, outputHMM);
