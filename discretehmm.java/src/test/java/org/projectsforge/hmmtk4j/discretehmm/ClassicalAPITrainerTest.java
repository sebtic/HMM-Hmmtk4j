...
public class ClassicalAPITrainerTest extends TestCase {
  static {
  ...
  public void testClass1() throws InterruptedException {
    ...
    final ClassicalAPITrainer trainer = new ClassicalAPITrainer(new LambdaModelArithmetic());
