...
public class Gradient extends Algorithm implements Serializable {
  ...
  protected void implement() {
    gradient = new HMM(inputHMM.getStateCount(), inputHMM.getSymbolCount());
    logOfTheProbability = org.projectsforge.hmmtk4j.discretehmm.nativeimplementors.Gradient
        .gradient(sequenceOfObservations, inputHMM, gradient);
  }
