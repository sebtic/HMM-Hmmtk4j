...
public class BaumWelch extends Algorithm implements Serializable {
  ...
  protected void implement() {
    ...
    logOfTheProbability = org.projectsforge.hmmtk4j.discretehmm.nativeimplementors.BaumWelch
        .baumWelch(inputHMM, sequenceOfObservations, nbMaxIteration, reevaluateA, reevaluateB, reevaluatePi,
            outputHMM);
