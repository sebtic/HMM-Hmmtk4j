...
/**
 * A fast and simplified event listener list.
 * 
 * @author Sébastien Aupetit
 * @param <TEventListener>
...
public class EventListenerList<TEventListener> implements Serializable {
   ...
   */
  private static final long serialVersionUID = -143517671830006102L;
  ...
  /**
   * Return a non null list of listener.
   * 
   ...
   * @throws IOException
   *           if an IO error occurs while writing objects
   */
