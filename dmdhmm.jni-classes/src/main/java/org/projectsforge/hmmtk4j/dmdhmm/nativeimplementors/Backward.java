...
public final class Backward {
  ...
  public static native void backward(final HMM inputHMM, final SequenceOfObservations observation,
      final ArrayOfDouble rescalingCoefs, final MatrixOfDouble betaTildes);
