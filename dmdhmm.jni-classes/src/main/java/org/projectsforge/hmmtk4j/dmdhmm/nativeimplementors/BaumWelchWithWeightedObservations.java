...
public final class BaumWelchWithWeightedObservations {
  ...
  public static native double baumWelchWithWeightedObservations(final HMM inputHMM,
      final WeightedSequenceOfObservations[] array, final int nbMaxIteration,
      final boolean reevaluateA, final boolean[] reevaluateB, final boolean reevaluatePi,
      final HMM outputHMM);
