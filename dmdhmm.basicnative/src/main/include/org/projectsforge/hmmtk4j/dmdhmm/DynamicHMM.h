...
#ifndef HMMTK4J_DMDHMM_DynamicHMM_h
#define HMMTK4J_DMDHMM_DynamicHMM_h
      ...
      namespace dmdhmm
      {
        ...
        class DynamicHMM: public IHMM
        {
          public:
            ...
            Ref<ArrayOfReference<DynamicMatrixOfDouble> > dynamic_B;
          public:
            DynamicHMM();
            /** Resize the HMM
             *
             * @param stateCount the state count
             * @param symbolCounts the symbol count
             */
            void resize(Integer stateCount, const Ref<IArray<Integer> > & symbolCounts);
            /** Copy a HMM
             *
